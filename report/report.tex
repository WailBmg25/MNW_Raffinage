...
\begin{tabular}{lrrrrrrr}
\toprule
Méthode & Precision & Recall & F1 & AUC & Avance (h) & Corr. vérité & Params \\
\midrule
\textbf{Résidu GRU} & 0.009 & 0.323 & 0.018 & 0.671 & 3022 & \textbf{0.490} & 57 793 \\
Autoencodeur dense & 0.035 & 0.135 & 0.055 & 0.780 & 2144 & 0.265 & 516 128 \\
Autoencodeur conv1D & 0.010 & 0.573 & 0.019 & 0.589 & 3752 & 0.250 & 19 331 \\
Autoencodeur LSTM & 0.024 & 0.469 & 0.046 & 0.652 & 4114 & 0.153 & 26 163 \\
VAE & 0.006 & 0.156 & 0.012 & 0.602 & 3974 & 0.062 & 259 808 \\
\bottomrule
\end{tabular}
\caption{Comparatif des 5 approches de détection de fouling (notebook 04)}
\end{table}

\textbf{Résultat : les 5 méthodes dépassent l'objectif de 24h. \checkmark} Precision/F1 sont
quasi nuls pour toutes les méthodes (déséquilibre extrême de l'étiquette rare, $\sim$0.9\%
d'heures positives) et ne sont donc pas discriminants. La \textbf{corrélation à la vérité
terrain cachée} (\texttt{fouling\_resistance}) départage les méthodes : le \textbf{résidu GRU}
— qui prédit spécifiquement la température de sortie du préchauffe (directement pilotée par le
fouling) plutôt que de reconstruire les 88 variables du procédé — est nettement le plus corrélé
(0.49 contre 0.06--0.27 pour les autoencodeurs, sensibles à toute variation opératoire).
\textbf{Production : résidu GRU}, score lissé par EWMA causal (span 24h).
...
d'alertes anti-rebond. \textbf{Latence moyenne mesurée : $\sim$23 ms} (objectif < 1 min). 107
